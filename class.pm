...
sub open_stream {
	...
	print $FH " * Generated by idl2java (Perl)\n";
	print $FH " * from ",$self->{srcname},", ",$self->{srcname_size}," octets, ",POSIX::ctime($self->{srcname_mtime});
	print $FH " * at ",POSIX::ctime(time());
	print $FH " */\n";
	print $FH "\n";
}
